function [dVdD,Cv_update] = f_get_BFT_coarseD (Ds,D_agg_med,sigma_agg, sigma, Lamda,f_l,study_name) 
...
% Output:    dVdD is a function handle
    ...
    elseif (strcmp(study_name,'kok_proposal_complex'))  
        ...
        elseif sigma_agg==2.95 && f_l==0.1
            %Cv_update = 260.4971*0.078401060921227*0.6374; %integral from 0 to 40
            %Cv_update = 260.4971*0.078401060921227*0.6374*0.6121*0.9547; %using Ds and sigma in Kok11 
            Cv_update = 260.4971*0.078401060921227*0.6374*0.6121*0.9547*1.3668;  %using Ds and sigma in Yue 2021 
        elseif sigma_agg==2.95 && f_l==0.15
            %Cv_update = 260.4971*0.078401060921227*0.6374; %integral from 0 to 40
            %Cv_update = 260.4971*0.078401060921227*0.6374*0.6121*0.9547; %using Ds and sigma in Kok11 
            Cv_update = 260.4971*0.078401060921227*0.6374*0.6121*0.9547*1.3668*1.1877;  %using Ds and sigma in Yue 2021 
        elseif sigma_agg==2.95 && f_l==0.2
            %Cv_update = 260.4971*0.078401060921227*0.6374; %integral from 0 to 40
            %Cv_update = 260.4971*0.078401060921227*0.6374*0.6121*0.9547; %using Ds and sigma in Kok11 
            Cv_update = 260.4971*0.078401060921227*0.6374*0.6121*0.9547*1.3668*1.3183;  %using Ds and sigma in Yue 2021     
